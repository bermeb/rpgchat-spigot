package dev.bermeb.rpgchat.nms.v1_19_R1;
...
public class CustomEntityRegistry<T> extends DefaultedRegistry {
    ...
    public CustomEntityRegistry(DefaultedRegistry<EntityType<?>> original) {
        super(original.getDefaultKey().getNamespace(), null, null, null);
    ...
    public ResourceLocation getKey(Object value) {
        ...
        return Objects.requireNonNull(wrapped.getKey((EntityType<?>) value));
    }
