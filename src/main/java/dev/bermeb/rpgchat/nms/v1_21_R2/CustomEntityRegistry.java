package dev.bermeb.rpgchat.nms.v1_21_R2;
...
import org.bukkit.craftbukkit.v1_21_R2.entity.boat.*;
...
public class CustomEntityRegistry<T> extends DefaultedMappedRegistry {
    ...
    static {
        ...
        minecraftClassMap.put(EntityType.CHERRY_BOAT, CraftCherryChestBoat.class);
        minecraftClassMap.put(EntityType.CHERRY_CHEST_BOAT, CraftCherryBoat.class);
        ...
        minecraftClassMap.put(EntityType.CREAKING_TRANSIENT, CreakingTransient.class);
