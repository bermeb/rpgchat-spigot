...
import org.bukkit.craftbukkit.v1_21_R6.entity.boat.*;
...
public class CustomEntityRegistry<T> extends DefaultedMappedRegistry {
    ...
    static {
        minecraftClassMap.put(EntityType.ACACIA_BOAT, CraftAcaciaBoat.class);
        minecraftClassMap.put(EntityType.ACACIA_CHEST_BOAT, CraftAcaciaChestBoat.class);
        ...
        minecraftClassMap.put(EntityType.BAMBOO_CHEST_RAFT, CraftBambooChestRaft.class);
        minecraftClassMap.put(EntityType.BAMBOO_RAFT, CraftBambooRaft.class);
        minecraftClassMap.put(EntityType.BAT, Bat.class);
        minecraftClassMap.put(EntityType.BEE, Bee.class);
        minecraftClassMap.put(EntityType.BIRCH_BOAT, CraftBirchBoat.class);
        minecraftClassMap.put(EntityType.BIRCH_CHEST_BOAT, CraftBirchChestBoat.class);
        ...
        minecraftClassMap.put(EntityType.CHERRY_BOAT, CraftCherryBoat.class);
        minecraftClassMap.put(EntityType.CHERRY_CHEST_BOAT, CraftCherryChestBoat.class);
        ...
        minecraftClassMap.put(EntityType.COPPER_GOLEM, CopperGolem.class);
        ...
        minecraftClassMap.put(EntityType.CREAKING, Creaking.class);
        minecraftClassMap.put(EntityType.CREEPER, Creeper.class);
        minecraftClassMap.put(EntityType.DARK_OAK_BOAT, CraftDarkOakBoat.class);
        minecraftClassMap.put(EntityType.DARK_OAK_CHEST_BOAT, CraftDarkOakChestBoat.class);
        ...
        minecraftClassMap.put(EntityType.HAPPY_GHAST, HappyGhast.class);
        ...
        minecraftClassMap.put(EntityType.JUNGLE_BOAT, CraftJungleBoat.class);
        minecraftClassMap.put(EntityType.JUNGLE_CHEST_BOAT, CraftJungleChestBoat.class);
        ...
        minecraftClassMap.put(EntityType.MANGROVE_BOAT, CraftMangroveBoat.class);
        minecraftClassMap.put(EntityType.MANGROVE_CHEST_BOAT, CraftMangroveChestBoat.class);
        minecraftClassMap.put(EntityType.MANNEQUIN, Mannequin.class);
        ...
        minecraftClassMap.put(EntityType.OAK_BOAT, CraftOakBoat.class);
        minecraftClassMap.put(EntityType.OAK_CHEST_BOAT, CraftOakChestBoat.class);
        ...
        minecraftClassMap.put(EntityType.PALE_OAK_BOAT, CraftPaleOakBoat.class);
        minecraftClassMap.put(EntityType.PALE_OAK_CHEST_BOAT, CraftPaleOakChestBoat.class);
        ...
        minecraftClassMap.put(EntityType.SPLASH_POTION, ThrownSplashPotion.class);
        minecraftClassMap.put(EntityType.LINGERING_POTION, ThrownLingeringPotion.class);
        ...
        minecraftClassMap.put(EntityType.SPRUCE_BOAT, CraftSpruceBoat.class);
        minecraftClassMap.put(EntityType.SPRUCE_CHEST_BOAT, CraftSpruceChestBoat.class);
